window.swaggerSpec={
  ...
  "info" : {
    ...
    "version" : "3.0",
    "x-comment" : "Generated from lti/input-jsonschema.json by core-types-json-schema (https://github.com/grantila/core-types-json-schema) on behalf of typeconv (https://github.com/grantila/typeconv)"
  },
  "paths" : { },
  "components" : {
    "schemas" : {
          ...
          "type" : {
            "items" : {
              "anyOf" : [ {
                ...
                "enum" : [ "http://purl.imsglobal.org/vocab/lis/v2/course#CourseTemplate", "http://purl.imsglobal.org/vocab/lis/v2/course#CourseOffering", "http://purl.imsglobal.org/vocab/lis/v2/course#CourseSection", "http://purl.imsglobal.org/vocab/lis/v2/course#CourseGroup" ]
              } ]
            },
      ...
      "DeepLinkingSettings.Type" : {
        ...
        "required" : [ "deep_link_return_url", "accept_types", "accept_presentation_document_targets" ],
        "additionalProperties" : false,
        "type" : "object"
      },
      "LTIJWTMessageCore.Type" : {
        "allOf" : [ {
          ...
          "required" : [ "https://purl.imsglobal.org/spec/lti/claim/roles", "https://purl.imsglobal.org/spec/lti/claim/tool_platform" ],
          "additionalProperties" : false,
          "type" : "object"
        } ]
      },
      "LTISecurityFrameworkJWT.Type" : {
        ...
        "required" : [ "iss", "aud", "exp", "iat", "nonce", "https://purl.imsglobal.org/spec/lti/claim/version", "https://purl.imsglobal.org/spec/lti/claim/deployment_id" ],
        "additionalProperties" : false,
